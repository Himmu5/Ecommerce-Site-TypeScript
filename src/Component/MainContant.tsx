import React, { DetailedHTMLProps, InputHTMLAttributes, SelectHTMLAttributes, useCallback, useContext, useEffect } from "react";
...
function MainContant() {
  ...
  function HandleSearch(e:InputHTMLAttributes<HTMLInputElement>) {
    setSearchParams(
      { ...params, searchQuery: e.target.value, page: 1 },
      { replace: false }
    );
  }
  function handleOnchange(e:SelectHTMLAttributes<HTMLSelectElement>) {
